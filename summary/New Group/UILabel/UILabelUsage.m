...
//  summary
//
//  Created by NewBoy on 2017/12/21.
//  Copyright © 2017年 LX. All rights reserved.
//  Monsonry关于label的用法

#import "UILabelUsage.h"
#import "Masonry.h"


@implementation UILabelUsage
...
-(void)viewDidLoad
{
    ...
    reasonLabel.text = @"案件司法案件司法案件司法案件司法";
    ...
    [reasonLabel3 mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        CGFloat width = (reasonLabel3.frame.size.width + 10) > (self.view.frame.size.width - 10 - 15) ? (self.view.frame.size.width - 10 - 15):(reasonLabel.frame.size.width + 10);
